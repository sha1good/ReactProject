...
export default connect(mapStateToProps,{ getProjectTaskByProjectIdentifierAndProjectSequence ,updateProjectTaskByProjectIdentifierAndProjectSequence})(UpdateProjectTask);